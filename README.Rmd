...
[![Codecov test coverage](https://codecov.io/gh/leonawicz/memery/graph/badge.svg)](https://app.codecov.io/gh/leonawicz/memery)
[![CRAN status](https://www.r-pkg.org/badges/version/memery)](https://CRAN.R-project.org/package=memery)
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/memery)](https://cran.r-project.org/package=memery) 
...
Matthew Leonawicz (`r substr(Sys.Date(), 1, 4)`). memery: Internet Memes for Data Analysts. R package version 0.6.0. https://CRAN.R-project.org/package=memery
