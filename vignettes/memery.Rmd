...
Since the philosoraptor image is a bit small for the detailed plot above, it is enlarged below when including the inset plot again. For now, drop the second text label. It will be relocated later.
